...
class ChatReplyImageWidget extends StatefulWidget {
  ChatReplyImageWidget(
      {super.key,
      required this.listOfChatDateDocument,
      required this.index,
      required this.receiverId,
      required this.name,
      required this.imageUrl,
      required this.replyId,
      required this.replyPhoneNumber,
      required this.isRead,
      required this.messageText,
      required this.sender,
      required this.time,
      required this.listOfChat});
  String sender;
  String messageText;
  int time;
  bool isRead;
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
                ...
                return AlertDialog(
                  ...
                  content: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Center(
                            child: Text('Delete message from ${widget.name}')),
                        SizedBox(
                          height: 10,
                        ),
                        MaterialButton(
                            ...
                            onPressed: () async {
                              ...
                              if (d1.exists) {
                                await FirebaseFirestore.instance
                                    ...
                                    .collection('conversation')
                                    .doc(widget
                                        .listOfChatDateDocument[widget.index]
                                        .id)
                                    .delete();
                              } else {
                                await FirebaseFirestore.instance
                              ...
                              if (d1.exists) {
                                await FirebaseFirestore.instance
                                    ...
                                    .doc(widget
                                        ...
                                        .id)
                                    .update({
                                  'deleteVisivility': [widget.receiverId]
                                });
                              } else {
                                await FirebaseFirestore.instance
                                    .collection('conversation')
      ...
      child: Container(
        ...
        child: Align(
          alignment: currentUser!.uid == widget.sender
              ? Alignment.topRight
              : Alignment.topLeft,
          child: Container(
              key: _containerKey,
                ...
                children: [
                  SizedBox.fromSize(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(10),
                          color: ColorUtils.white.withOpacity(0.15)),
                      child: GroupCollection.fetchOneMessage(
                                  widget.listOfChat, widget.replyId)
                              .isNotEmpty
                          ? Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(
                                  widget.replyPhoneNumber ==
                                          getNum1(
                                ...
                                Text(
                                  GroupCollection.fetchOneMessage(
                                      widget.listOfChat, widget.replyId),
                                  style: TextStyle(
                                ...
                                ClipRRect(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: CacheNetworkImageWidget(
                                      imageUrl:
                                          GroupCollection.fetchOneImageUrl(
                                              widget.listOfChat,
                                              widget.replyId),
                                    ),
                                  ),
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => ShowImage(
                                  name: currentUser!.uid == widget.sender
                                      ? 'you'
                                      : widget.name,
